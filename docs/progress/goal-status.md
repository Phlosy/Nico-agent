...
| F | In Progress | 78% | F1–F6 已完成；Memory 生命周期及 SkillVersion 比较/发布/灰度/推广/弃用/禁用/回滚已实现；170 单测、7 前端测试/构建、57 真实集成通过 | 尚未创建 | 无；Goal F REST API/E2E 待 F7/F8，Team scope 在 Goal G 前失败关闭 |
