"""Alembic environment using the same async database configuration as runtime."""
...
from nico_agent.domain import models  # noqa: F401 - register metadata for autogenerate
