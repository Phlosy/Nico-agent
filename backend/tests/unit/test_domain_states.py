...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("project_member", PROJECT_MEMBER_TRANSITIONS),
        ("project_session", PROJECT_SESSION_TRANSITIONS),
        ("project_supervision", PROJECT_SUPERVISION_TRANSITIONS),
        ("run_intervention", RUN_INTERVENTION_TRANSITIONS),
